...
set = 'Fossil'  # Different dataset with different
model_name = ''
...
#pretrain_path = './models/pretrained/epoch20.pth'
...
if set == 'CUB':
    ...
    if set == 'CAR':
        ...
        model_path = './checkpoint/furniture'      # pth save path
        root = './datasets/Furniture'  # dataset path
        num_classes = 29
    elif set == 'Fossil':
        model_path = './checkpoint/fossil'      # pth save path
        root = './datasets/Fossil'  # dataset path
        num_classes = 60
